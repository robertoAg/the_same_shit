...
?>
    ...
    <tr id="rw_font_color" class="rw-even">
        ...
        <td>
            <div id="colorSelector" class="rw-color-selector"><div style="background-color: <?php 
echo  $font->color ;
?>
"></div></div>
        </td>
    ...
    <tr id="rw_font_hover_color" class="rw-odd">
        ...
        <td>
            <div id="hoverColorSelector" class="rw-color-selector"><div style="background-color: <?php 
...
');">
    ...
    ?>
                ...
                <input type="radio" name="rw-font-type" value="<?php 
    echo  $f ;
    ?>
"<?php 
    if ( $font->type == $f ) {
