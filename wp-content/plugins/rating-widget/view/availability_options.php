...
?>
">
                    <i class="rw-ui-sprite rw-ui-availability-disabled"></i> <input type="radio" name="rw_availability" value="1" <?php 
checked( $availability, 1 );
?>
> <span>Disable <?php 
echo  $types ;
?>
 ratings for unlogged users.</span>
                </div>
                <div class="rw-ui-img-radio rw-ui-hor<?php 
if ( $availability == 2 ) {
    echo  ' rw-selected' ;
...
?>
">
                    <i class="rw-ui-sprite  rw-ui-availability-hidden"></i> <input type="radio" name="rw_availability" value="2" <?php 
checked( $availability, 2 );
?>
> <span>Hide <?php 
echo  $types ;
?>
 ratings from unlogged users.</span>
                </div>
            </div>
        </div>
    </div>
