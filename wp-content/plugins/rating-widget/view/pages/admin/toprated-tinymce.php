...
">
		...
		<title><?php 
_e( 'Add Top-Rated Table', WP_RW__ID );
?>
</title>
...
resources/css/toprated-shortcode-old.css"/>
	...
	<body>
		<form>
			<div class="tabs">
				<ul>
					<li id="rw-options-tab" aria-controls="rw-options-panel" class="current"><span><?php 
_e( 'Table Options', WP_RW__ID );
?>
</span></li>
				</ul>
			</div>
...
:</label></th>
						...
						<tr>
							<th><?php 
_e( 'Direction', WP_RW__ID );
?>
:</th>
							<td>
								<div id='rw-toprated-direction'>
									<label class="rw-toprated-ltr"><input name="rw-toprated-direction" value="ltr" type="radio" checked /> <span><?php 
_e( 'Left to Right', WP_RW__ID );
?>
</span></label> <label><input name="rw-toprated-direction" value="rtl" type="radio" /> <span><?php 
_e( 'Right to Left', WP_RW__ID );
?>
</span></label>
								</div>
							</td>
...
_e( 'Average Rate', WP_RW__ID );
?>
</option>
									<option value="votes"><?php 
_e( 'Votes Number', WP_RW__ID );
?>
</option>
									<option value="likes"><?php 
_e( 'Likes (for Thumbs)', WP_RW__ID );
?>
</option>
									<option value="created"><?php 
_e( 'Created', WP_RW__ID );
?>
</option>
									<option value="updated"><?php 
_e( 'Updated', WP_RW__ID );
?>
</option>
								</select>
							</td>
...
_e( 'BEST (Descending)', WP_RW__ID );
?>
</option>
									<option value="ASC"><?php 
_e( 'WORST (Ascending)', WP_RW__ID );
?>
</option>
								</select>
							</td>
...
?>
						...
						<tr>
							<td colspan='2'>
								<div id="rw-toprated-note"><?php 
_e( 'Note: After clicking "Add Table", a special shortcode will be added to your editor. It would be rendered as a beautiful table only in your site.', WP_RW__ID );
?>
</div>
							</td>
						</tr>
